...
!(function (t, e) {
  ...
  class Ti {
    ...
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        a &&
        ((n.values = a), (t.min = Math.min(t.min, s)), (t.max = Math.max(t.max, s)), (s = Mi(n, o, this._cachedMeta.index, { all: !0 }))),
  ...
  function qn(t) {
    return (
      Xn() && "string" == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
    );
  }
  const Kn = {},
    Gn = (t) => {
  ...
  (wo.id = "arc"),
    (wo.defaults = { borderAlign: "center", borderColor: "#fff", borderRadius: 0, borderWidth: 2, offset: 0, angle: void 0 }),
      ...
      t.data.datasets.forEach((e, o) => {
        ...
        let h,
          { start: d, count: u } = (function (t, e) {
            ...
            return (
              l && (o = Nt(ne(e, s.axis, a).lo, 0, i - 1)), (n = c ? Nt(ne(e, s.axis, r).hi + 1, o, i) - o : i - o), { start: o, count: n }
            );
          })(r, l);
        if (u <= 4 * n) $o(e);
        else {
              ...
              h = (function (t, e, i, n, o) {
                ...
                for (a[l++] = t[p], h = 0; h < s - 2; h++) {
                  ...
                  const b = Math.floor(h * r) + 1 + e,
                    ...
                    { x: y, y: v } = t[p];
                  for (u = f = -1, n = b; n < _; n++)
                    (f = 0.5 * Math.abs((y - o) * (t[n].y - v) - (y - t[n].x) * (s - v))), f > u && ((u = f), (d = t[n]), (g = n));
                  (a[l++] = d), (p = g);
                }
                return (a[l++] = t[c]), a;
              })(l, d, u, n, i);
        ...
        for (const t of n) {
          ...
          for (const e of r) {
            const r = ns(i, s[e.start], s[e.end], e.loop),
              l = yn(t, o, r);
            for (const t of l)
              a.push({ source: t, target: e, start: { [i]: os(n, r, "start", Math.max) }, end: { [i]: os(n, r, "end", Math.min) } });
          }
        }
        return a;
      })(i, n, o);
    ...
    n &&
      ...
      (function (t, e) {
        ...
        t.save(),
          "x" === l &&
            s !== o &&
            (is(t, n, a.top), rs(t, { line: i, target: n, color: o, scale: r, property: l }), t.restore(), t.save(), is(t, n, a.bottom)),
      ...
      t.legendItems.forEach((e, M) => {
        ...
        h.setWidth(t.width),
          y
            ...
            : M > 0 &&
              C + w > t.bottom &&
              ((D = m.x = D + i[m.line].width + f), m.line++, (C = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height)));
        !(function (t, e, i) {
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        (_ = Math.ceil(u / y) - Math.floor(d / y)),
          ...
          (b = Math.round(b * m) / m);
        let v = 0;
        for (f && (i.push({ value: o }), x <= o && v++, At(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _; ++v)
  ...
  function Ys(t, e) {
    ...
    return (
      ...
      null === r ? null : (s && (r = "week" !== s || (!Ot(a) && !0 !== a) ? i.startOf(r, s) : i.startOf(r, "isoWeek", a)), +r)
    );
  }
  function Us(t, e, i, n) {
    const o = js.length;
