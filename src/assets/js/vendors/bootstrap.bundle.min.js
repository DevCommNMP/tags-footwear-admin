  ...
  function St(t) {
    ...
    return a
      ? Object.assign(
          ...
          (_[p] = d ? "0" : ""),
          (_.transform =
            (m.devicePixelRatio || 1) < 2 ? "translate(" + u + "px, " + f + "px)" : "translate3d(" + u + "px, " + f + "px, 0)"),
          _),
        )
        ...
        for (
          var o = n.mainAxis,
            ...
            b = [m].concat(_).reduce(function (t, n) {
              return t.concat(
                "auto" === mt(n)
                  ? $t(e, { placement: n, boundary: u, rootBoundary: f, padding: c, flipVariations: p, allowedAutoPlacements: g })
                  : n,
              );
            }, []),
            y = e.rects.reference,
    ...
    Te = (function (t) {
      ...
      return (
        ...
        (r._getPopperConfig = function () {
          ...
          return (
            "static" === this._config.display && (t.modifiers = [{ name: "applyStyles", enabled: !1 }]), n({}, t, this._config.popperConfig)
          );
        }),
        ...
        (o.dataApiKeydownHandler = function (t) {
          if (
            ...
            if ("Escape" === t.key)
              return (
                (this.matches('[data-bs-toggle="dropdown"]') ? this : q.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(),
                void o.clearMenus()
              );
            if (n && "Space" !== t.key) {
