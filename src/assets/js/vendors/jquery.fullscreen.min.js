...
(function (global, factory) {
  ...
  FullScreenAbstract.prototype = {
    native: native,
    _DEFAULT_OPTIONS: { styles: { boxSizing: "border-box", MozBoxSizing: "border-box", WebkitBoxSizing: "border-box" }, toggleClass: null },
    __documentOverflow: "",
    __htmlOverflow: "",
    ...
    _fullScreenChange: function () {
      this.__options &&
        (this.isFullScreen()
          ...
          : (this._allowDocumentScroll(), this._revertStyles(), this._triggerEvents(), (this._fullScreenElement = null)));
    },
    ...
    _saveAndApplyStyles: function () {
      ...
      for (var b in this.__options.styles)
        (this.__savedStyles[b] = this._fullScreenElement.style[b]), (this._fullScreenElement.style[b] = this.__options.styles[b]);
